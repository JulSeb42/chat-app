...
export default (plop: NodePlopAPI) => {
	...
	setGenerator("context", {
		...
		actions: [
			{
				type: "addMany",
				destination: `${CLIENT_PATH}/context/{{>kebabName}}`,
